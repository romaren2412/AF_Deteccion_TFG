...
from MNIST.Ataques.byzantine import select_byzantine_range
    ...
    with device:
        ...
        for e in range(epochs):
            ...
            for ap in aprendedores:
                ap.sl.adestrar(softmax_cross_entropy, global_net, grad_list)
        ...
        resumo_final(testloader_global, global_net, device, e, malicious_score, path, undetected_byz_index)
    return None
